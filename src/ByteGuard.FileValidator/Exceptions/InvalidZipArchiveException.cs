...
/// <summary>
/// Exception type used specifically when a given file is invalid based on the ZIP validation.
/// </summary>
public class InvalidZipArchiveException : Exception
{
    ...
    /// ZIP-archive structure in the provided file is not valid based on the defined validation configurations.
    /// </summary>
    public InvalidZipArchiveException()
        : base("ZIP-archive is invalid based on the defined validation configurations.")
    {
    }
